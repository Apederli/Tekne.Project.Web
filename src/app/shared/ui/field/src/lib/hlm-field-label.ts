...
export class HlmFieldLabel {
  constructor() {
    classes(() => [
      ...
      // Yerel ayar: hata renklendirmesi hlm-field sarmalayıcısından buraya
      // taşındı — input değeri kızarmadan yalnız etiket kızarsın.
      'group-data-[matches-spartan-invalid=true]/field:text-destructive',
    ]);
  }
}
